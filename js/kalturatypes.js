...
function KalturaFairplayDrmProfileOrderBy(){
}
KalturaFairplayDrmProfileOrderBy.ID_ASC = "+id";
KalturaFairplayDrmProfileOrderBy.NAME_ASC = "+name";
KalturaFairplayDrmProfileOrderBy.ID_DESC = "-id";
KalturaFairplayDrmProfileOrderBy.NAME_DESC = "-name";

function KalturaFeedDropFolderFileOrderBy(){
}
KalturaFeedDropFolderFileOrderBy.CREATED_AT_ASC = "+createdAt";
KalturaFeedDropFolderFileOrderBy.FILE_NAME_ASC = "+fileName";
KalturaFeedDropFolderFileOrderBy.FILE_SIZE_ASC = "+fileSize";
KalturaFeedDropFolderFileOrderBy.FILE_SIZE_LAST_SET_AT_ASC = "+fileSizeLastSetAt";
KalturaFeedDropFolderFileOrderBy.ID_ASC = "+id";
KalturaFeedDropFolderFileOrderBy.PARSED_FLAVOR_ASC = "+parsedFlavor";
KalturaFeedDropFolderFileOrderBy.PARSED_SLUG_ASC = "+parsedSlug";
KalturaFeedDropFolderFileOrderBy.UPDATED_AT_ASC = "+updatedAt";
KalturaFeedDropFolderFileOrderBy.CREATED_AT_DESC = "-createdAt";
KalturaFeedDropFolderFileOrderBy.FILE_NAME_DESC = "-fileName";
KalturaFeedDropFolderFileOrderBy.FILE_SIZE_DESC = "-fileSize";
KalturaFeedDropFolderFileOrderBy.FILE_SIZE_LAST_SET_AT_DESC = "-fileSizeLastSetAt";
KalturaFeedDropFolderFileOrderBy.ID_DESC = "-id";
KalturaFeedDropFolderFileOrderBy.PARSED_FLAVOR_DESC = "-parsedFlavor";
KalturaFeedDropFolderFileOrderBy.PARSED_SLUG_DESC = "-parsedSlug";
KalturaFeedDropFolderFileOrderBy.UPDATED_AT_DESC = "-updatedAt";

function KalturaFeedDropFolderOrderBy(){
}
KalturaFeedDropFolderOrderBy.CREATED_AT_ASC = "+createdAt";
KalturaFeedDropFolderOrderBy.ID_ASC = "+id";
KalturaFeedDropFolderOrderBy.NAME_ASC = "+name";
KalturaFeedDropFolderOrderBy.UPDATED_AT_ASC = "+updatedAt";
KalturaFeedDropFolderOrderBy.CREATED_AT_DESC = "-createdAt";
KalturaFeedDropFolderOrderBy.ID_DESC = "-id";
KalturaFeedDropFolderOrderBy.NAME_DESC = "-name";
KalturaFeedDropFolderOrderBy.UPDATED_AT_DESC = "-updatedAt";
...
function KalturaLiveEntryServerNodeOrderBy(){
}
KalturaLiveEntryServerNodeOrderBy.CREATED_AT_ASC = "+createdAt";
KalturaLiveEntryServerNodeOrderBy.UPDATED_AT_ASC = "+updatedAt";
KalturaLiveEntryServerNodeOrderBy.CREATED_AT_DESC = "-createdAt";
KalturaLiveEntryServerNodeOrderBy.UPDATED_AT_DESC = "-updatedAt";
