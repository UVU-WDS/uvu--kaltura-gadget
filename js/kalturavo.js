...
KalturaBulkUploadICalJobData.inheritsFrom (KalturaBulkUploadJobData);
...
KalturaEntryServerNodeBaseFilter.inheritsFrom (KalturaRelatedFilter);
...
KalturaLiveStreamScheduleEvent.inheritsFrom (KalturaEntryScheduleEvent);
...
/**
 */
function KalturaFairplayDrmProfileBaseFilter(){
}
KalturaFairplayDrmProfileBaseFilter.inheritsFrom (KalturaDrmProfileFilter);
...
KalturaFeedDropFolderBaseFilter.inheritsFrom (KalturaDropFolderFilter);
...
KalturaFeedDropFolderFileBaseFilter.inheritsFrom (KalturaDropFolderFileFilter);
...
/**
 */
function KalturaFairplayDrmProfileFilter(){
}
KalturaFairplayDrmProfileFilter.inheritsFrom (KalturaFairplayDrmProfileBaseFilter);
...
KalturaFeedDropFolderFileFilter.inheritsFrom (KalturaFeedDropFolderFileBaseFilter);
...
KalturaFeedDropFolderFilter.inheritsFrom (KalturaFeedDropFolderBaseFilter);
