...
KalturaClient.prototype.init = function(config){
	...
	this.avn = new KalturaAvnService(this);
	...
	this.captureSpace = new KalturaCaptureSpaceService(this);
	this.comcastMrss = new KalturaComcastMrssService(this);
	...
	this.doubleClick = new KalturaDoubleClickService(this);
	...
	this.liveConversionProfile = new KalturaLiveConversionProfileService(this);
	...
	this.businessProcessServer = new KalturaBusinessProcessServerService(this);
